...
<html lang="en-US">
  ...
  Github
  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a></div> <!----></nav>  <ul class="sidebar-links"><li><a href="/bus/" class="sidebar-link">Home</a></li><li><a href="/bus/packages/bus-messages/" class="sidebar-link">Messages</a></li><li><a href="/bus/packages/bus-core/src/handler/" class="sidebar-link">Handlers</a></li><li><a href="/bus/packages/bus-core/src/transport/" class="sidebar-link">Transports</a></li><li><a href="/bus/packages/bus-workflow/" class="sidebar-link">Workflows</a></li><li><a href="/bus/packages/bus-workflow/src/workflow/persistence/" class="sidebar-link">Persistence</a></li></ul> </aside> <main class="page"> <div class="theme-default-content content__default"><p>A lot of effort has been put into <code>faker.js</code> to create a useful and handy
library. There are still a lot of things to be done, so all contributions are
welcome! If you can make <code>faker.js</code> better, please read the following contribution guide.</p> <h1 id="important"><a href="#important" aria-hidden="true" class="header-anchor">#</a> Important</h1> <ul><li>Please make sure that you run both <code>gulp</code> and tests before making a PR.</li></ul> <h2 id="support"><a href="#support" aria-hidden="true" class="header-anchor">#</a> Support</h2> <p><code>faker.js</code> relies on <a href="http://www.commonjs.org/" target="_blank" rel="noopener noreferrer">commonJS<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a> standard and supports both node.js and the
browsers. Keep this in mind, when modifying and/or extending the sources.</p> <h2 id="automation"><a href="#automation" aria-hidden="true" class="header-anchor">#</a> Automation</h2> <ul><li>The project is being built by <a href="http://gulpjs.com/" target="_blank" rel="noopener noreferrer">gulp<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a> (see <a href="build/gulpfile.js">gulpfile</a>), destination directory is <a href="build/build">build/build</a></li> <li>The documentation is auto-generated, based on <a href="build/src">build/src</a> markdown sources. If you modify the main <a href="/bus/packages/bus-test/node_modules/faker/" class="router-link-active">Readme.md</a> file, the Pull Request will be rejected, since it will be overwritten by the upcoming <code>gulp</code> execution</li> <li>The tests are executing <code>mocha</code> against all js contents of <a href="test">test</a> directory</li></ul> <h2 id="architecture"><a href="#architecture" aria-hidden="true" class="header-anchor">#</a> Architecture</h2> <p>The sources are located in the <a href="lib">lib</a> directory. All fake data generators are
divided into namespaces (each namespace being a separate module). Most of the
generators use the <em>definitions</em>, which are just plain JavaScript
objects/arrays/strings that are separate for each <a href="lib/locales">locale</a>.</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/bus/assets/js/app.9b9c970b.js" defer></script><script src="/bus/assets/js/2.40db6fc8.js" defer></script><script src="/bus/assets/js/27.6d0990f4.js" defer></script>
  </body>
</html>
