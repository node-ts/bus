...
<html lang="en-US">
  <head>
    ...
    <title>changes log | @node-ts/bus</title>
...
the <code>includePrerelease</code> option flag.</li></ul> <h2 id="_5-5"><a href="#_5-5" aria-hidden="true" class="header-anchor">#</a> 5.5</h2> <ul><li>Add version coercion capabilities</li></ul> <h2 id="_5-4"><a href="#_5-4" aria-hidden="true" class="header-anchor">#</a> 5.4</h2> <ul><li>Add intersection checking</li></ul> <h2 id="_5-3"><a href="#_5-3" aria-hidden="true" class="header-anchor">#</a> 5.3</h2> <ul><li>Add <code>minSatisfying</code> method</li></ul> <h2 id="_5-2"><a href="#_5-2" aria-hidden="true" class="header-anchor">#</a> 5.2</h2> <ul><li>Add <code>prerelease(v)</code> that returns prerelease components</li></ul> <h2 id="_5-1"><a href="#_5-1" aria-hidden="true" class="header-anchor">#</a> 5.1</h2> <ul><li>Add Backus-Naur for ranges</li> <li>Remove excessively cute inspection methods</li></ul> <h2 id="_5-0"><a href="#_5-0" aria-hidden="true" class="header-anchor">#</a> 5.0</h2> <ul><li>Remove AMD/Browserified build artifacts</li> <li>Fix ltr and gtr when using the <code>*</code> range</li> <li>Fix for range <code>*</code> with a prerelease identifier</li></ul></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/bus/assets/js/app.9b9c970b.js" defer></script><script src="/bus/assets/js/2.40db6fc8.js" defer></script><script src="/bus/assets/js/31.ee0536bc.js" defer></script>
  </body>
</html>
